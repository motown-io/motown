...
public final class OperatorApiResponse<T> {
    ...
    /**
     * Construct a new Operator API response.
     *
     ...
     */
    public OperatorApiResponse(String href, NavigationItem previous, NavigationItem next, NavigationItem first, NavigationItem last, List<T> elements) {
