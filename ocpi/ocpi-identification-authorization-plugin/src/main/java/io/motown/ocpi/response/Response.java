...
public class Response {
	...
	public enum StatusCode {
		...
		SUCCESS(1000), CLIENT_ERROR(2000), INVALID_OR_MISSING_PARAMETERS(2001), GENERIC_SERVER_ERROR(
				3000), UNABLE_TO_USE_CLIENT_API(3001), UNSUPPORTED_VERSION(3002);
		 ...
		 *             if this enum has no constant for the specified numeric
		 *             value
		 */
	...
	public String toString() {
		return timestamp + " " + this.getClass().getName() + "; status: " + status_code + "; message: "
				+ status_message;
	}
}
