...
public class UnlockConnectorResponseHandler extends ResponseHandler {
    ...
    public void handle(ChargingStationId chargingStationId, WampMessage wampMessage, Gson gson, DomainService domainService) {
        ...
        RequestStatus requestStatus = response.getStatus().equals(UnlockStatus.ACCEPTED) ? RequestStatus.SUCCESS : RequestStatus.FAILURE;

        domainService.statusChanged(chargingStationId, requestStatus, getCorrelationToken(), "");
    }
