...
public class GetLocalListVersionResponseHandler extends ResponseHandler {

    public GetLocalListVersionResponseHandler(CorrelationToken correlationToken) {
    ...
    public void handle(ChargingStationId chargingStationId, WampMessage wampMessage, Gson gson, DomainService domainService, AddOnIdentity addOnIdentity) {
        ...
        domainService.authorizationListVersionReceived(chargingStationId, response.getListVersion().intValue(), getCorrelationToken());
    }
}
