...
public class ChangeConfigurationResponseHandlerTest {
    ...
    public void setup() {
        ...
        handler = new ChangeConfigurationResponseHandler(CONFIGURATION_ITEM, correlationToken);
    }
    ...
    public void handleAcceptedResponse() {
        ...
        verify(domainService).changeConfiguration(CHARGING_STATION_ID, CONFIGURATION_ITEM, correlationToken, ADD_ON_IDENTITY);
    }
