...
public class DenyAuthorizationCommandTest {

    @Test(expected = NullPointerException.class)
    public void createCommandWithNullChargingStationId() {
        new DenyAuthorizationCommand(null, IDENTIFYING_TOKEN, ROOT_IDENTITY_CONTEXT);
    }

    @Test(expected = NullPointerException.class)
    public void createCommandWithNullIdentifyingToken() {
        new DenyAuthorizationCommand(CHARGING_STATION_ID, null, ROOT_IDENTITY_CONTEXT);
    }
