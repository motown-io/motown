...
/**
 * {@code ReservationRejectedEvent} serves as a base class for events that inform about the resulting status of a request
...
public class ReservationRejectedEvent {
    ...
    /**
     * Creates a {@code ReservationRejectedEvent} with an identifier and new status.
     *
     ...
     */
    public ReservationRejectedEvent(ChargingStationId chargingStationId, EvseId evseId, IdentityContext identityContext) {
    ...
    public boolean equals(Object obj) {
        ...
        final ReservationRejectedEvent other = (ReservationRejectedEvent) obj;
