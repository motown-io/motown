...
/**
 * {@code ChargingStationUnavailableEvent} serves as a base class for events that inform about the resulting status of a request
 * that has been sent to the charging station.
 */
public class ChargingStationUnavailableEvent {
    ...
    /**
     * Creates a {@code ChargingStationUnavailableEvent} with an identifier and new status.
     *
     ...
     */
    public ChargingStationUnavailableEvent(ChargingStationId chargingStationId, EvseId evseId, IdentityContext identityContext) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChargingStationUnavailableEvent other = (ChargingStationUnavailableEvent) obj;
