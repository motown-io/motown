...
/**
 * {@code MakeChargingStationNotReservableCommand} is the command which is published when a charging station should be marked
 * as not reservable.
 */
public final class MakeChargingStationNotReservableCommand {
