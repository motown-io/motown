...
/**
 * {@code NowInoperativeEvent} informs that the evse is in an inoperative state.
 */
public class NowInoperativeEvent {
    ...
    /**
     * Creates a {@code NowInoperativeEvent}.
     *
     ...
     */
    public NowInoperativeEvent(ChargingStationId chargingStationId, EvseId evseId, IdentityContext identityContext) {
    ...
    public boolean equals(Object obj) {
        ...
        final NowInoperativeEvent other = (NowInoperativeEvent) obj;
