...
/**
 * {@code ReservationFaultedEvent} serves as a base class for events that inform about the resulting status of a request
 * that has been sent to the charging station.
 */
public class ReservationFaultedEvent {
    ...
    /**
     * Creates a {@code ReservationFaultedEvent} with an identifier and new status.
     *
     ...
     */
    public ReservationFaultedEvent(ChargingStationId chargingStationId, EvseId evseId, IdentityContext identityContext) {
    ...
    public boolean equals(Object obj) {
        ...
        final ReservationFaultedEvent other = (ReservationFaultedEvent) obj;
