...
/**
 * A number based reservation identifier.
 * <p/>
 * The number on which this reservation identifier is based should be unique within a Motown protocol add-on.
 */
public final class NumberedReservationId implements ReservationId {
     ...
     * <p/>
     * To improve the uniqueness of this identifier it is required to provide identifiers of the charging
     ...
     */
    public NumberedReservationId(ChargingStationId chargingStationId, String protocol, int number) {
    ...
    /**
     * Gets the textual representation of the identifier.
     * <p/>
