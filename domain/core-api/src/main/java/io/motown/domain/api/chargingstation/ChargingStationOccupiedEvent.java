...
/**
 * {@code ChargingStationOccupiedEvent} serves as a base class for events that inform about the resulting status of a request
 * that has been sent to the charging station.
 */
public class ChargingStationOccupiedEvent {
    ...
    /**
     * Creates a {@code ChargingStationOccupiedEvent} with an identifier and new status.
     *
     ...
     */
    public ChargingStationOccupiedEvent(ChargingStationId chargingStationId, EvseId evseId, IdentityContext identityContext) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChargingStationOccupiedEvent other = (ChargingStationOccupiedEvent) obj;
