...
/**
 * {@code GrantPermissionCommand} is the command which is published when a UserIdentity is granted permission
 * to a specific command.
 */
public final class GrantPermissionCommand {
    ...
    /**
     * Creates a {@code GrantPermissionCommand} with an identifier, userIdentity, commandClass and identityContext.
     *
     ...
     */
    public GrantPermissionCommand(ChargingStationId chargingStationId, UserIdentity userIdentity, Class commandClass, IdentityContext identityContext) {
    ...
    public boolean equals(Object obj) {
        ...
        final GrantPermissionCommand other = (GrantPermissionCommand) obj;
