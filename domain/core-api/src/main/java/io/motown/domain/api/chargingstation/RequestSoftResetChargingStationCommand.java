...
public final class RequestSoftResetChargingStationCommand {
    ...
    /**
     * Creates a {@code RequestSoftResetChargingStationCommand} with an identifier.
     *
     * @param chargingStationId the identifier of the charging station.
     * @throws NullPointerException if {@code chargingStationId} is {@code null}.
     */
    public RequestSoftResetChargingStationCommand(ChargingStationId chargingStationId) {
