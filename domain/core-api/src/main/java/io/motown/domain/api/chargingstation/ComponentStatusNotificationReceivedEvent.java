...
/**
 * {@code ComponentStatusNotificationCommand} is the event which is published when a charging station has notified
 * Motown about the status of one of its components.
 */
public final class ComponentStatusNotificationReceivedEvent extends StatusNotificationReceivedEvent {
