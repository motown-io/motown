...
public final class UnconfiguredChargingStationBootedEvent extends ChargingStationBootedEvent {
     ...
     */
    public UnconfiguredChargingStationBootedEvent(ChargingStationId chargingStationId, String protocol, Map<String, String> attributes, IdentityContext identityContext) {
