...
public class ChargingStationRepository {
    ...
    public LocalAuthChargingStation createOrUpdate(LocalAuthChargingStation chargingStation) {
        ...
        try {
            ...
            LocalAuthChargingStation persistedChargingStation = entityManager.merge(chargingStation);
