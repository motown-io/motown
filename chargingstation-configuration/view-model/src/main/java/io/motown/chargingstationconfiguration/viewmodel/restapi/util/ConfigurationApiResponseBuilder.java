...
import io.motown.chargingstationconfiguration.viewmodel.restapi.response.ConfigurationApiResponse;
import io.motown.chargingstationconfiguration.viewmodel.restapi.response.NavigationItem;
...
public final class ConfigurationApiResponseBuilder {
    private static final String QUERY_STRING_FORMAT = "?offset=%d&limit=%d";

    private ConfigurationApiResponseBuilder() {
    }

    /**
     * Build a {@link io.motown.chargingstationconfiguration.viewmodel.restapi.response.ConfigurationApiResponse} from the request, offset, limit, total and list of elements.
     *
     ...
     */
    public static <T> ConfigurationApiResponse<T> buildResponse(final HttpServletRequest request, final int offset, final int limit, final long total, final List<T> elements) {
        ...
        return new ConfigurationApiResponse<>(href, previous, next, first, last, elements);
    }
