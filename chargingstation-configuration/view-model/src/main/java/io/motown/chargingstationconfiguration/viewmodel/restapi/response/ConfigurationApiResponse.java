...
/**
 * Response to be sent from the Configuration API. The response consists of the current request URI, the previous, next, first and last navigation links and a list of elements.
 *
 * @param <T> The type of element. This can be either one of {@link io.motown.chargingstationconfiguration.viewmodel.persistence.entities.ChargingStationType} or {@link io.motown.chargingstationconfiguration.viewmodel.persistence.entities.Manufacturer}.
 */
public final class ConfigurationApiResponse<T> {
    ...
    public ConfigurationApiResponse(String href, NavigationItem previous, NavigationItem next, NavigationItem first, NavigationItem last, List<T> elements) {
